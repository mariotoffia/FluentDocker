...
namespace Ductus.FluentDocker.Builders
{
    public sealed class HostBuilder : BaseBuilder<IHostService>
    {
        ...
        // Same as <see cref="UseSsh" /> but uses docker context instead of docker-machine
        public DockerContextAwareRemoteBuilder UseContextSsh(string uri = null)
        {
            var builder = new DockerContextAwareRemoteBuilder(this, uri);
            Childs.Add(builder);
            return builder;
        }
