...
namespace FluentDocker.Builders
{
  ...
  {
    public FluentDockerKernel Kernel { get; set; } = null!;
    public string DriverId { get; set; } = null!;
    public object? ResourceBuilder { get; set; }
    public Func<TimeSpan, CancellationToken, Task<IServiceAsync>> ExecuteAsync { get; set; } = null!;
    ...
    public string ResourceKind { get; set; } = null!;
