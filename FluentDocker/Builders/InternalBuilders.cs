...
namespace FluentDocker.Builders
{
    ...
    internal class NetworkBuilder : INetworkBuilder, IDriverScopedBuilder
    {
        ...
        public async Task<IService> ExecuteAsync(CancellationToken cancellationToken)
        {
            ...
            {
                Name = _name, Driver = _driver, Subnet = _subnet,
                Gateway = _gateway, EnableIPv6 = _enableIPv6,
                Internal = _internal, Labels = _labels, Options = _options
            };
    ...
    internal class VolumeBuilder : IVolumeBuilder, IDriverScopedBuilder
    {
        ...
        public async Task<IService> ExecuteAsync(CancellationToken cancellationToken)
        {
            ...
            {
                Name = _name, Driver = _driver,
                DriverOpts = _driverOpts, Labels = _labels
            };
    ...
    internal class ComposeBuilder : IComposeBuilder, IDriverScopedBuilder
    {
        ...
        public async Task<IService> ExecuteAsync(CancellationToken cancellationToken)
        {
            ...
            {
                ComposeFiles = _composeFiles, ProjectName = _projectName,
                Environment = _environment, Build = _build,
