...
namespace FluentDocker.Commands
{
  ...
  /// </summary>
  /// <remarks>
  /// This class is deprecated. Use the IVolumeDriver interface from the FluentDocker.Drivers namespace instead.
  /// The Driver layer provides async operations, better error handling, and support for multiple container runtimes.
  /// </remarks>
  [System.Obsolete("Use IVolumeDriver from FluentDocker.Drivers namespace instead. Will be removed in v4.0.0.")]
